<?php $this->layout('base')?>
    ...
    <div class="borderHoja">
        <div class="row hoja" ondragover="Report.EventsDragDrop.allowDrop(event)" ondrop="Report.EventsDragDrop.hojaDrop(event)">
            ...
            <div id="pageHeader" data-typeelement = 'pageHeader' data-nameTag="detail" data-xml="<detail><band height='79' status='noVisited' splitType='Stretch'/></detail>" class="split split-vertical">
            </div>
            <div id="columnHeader" data-typeelement = 'columnHeader' data-nameTag="detail" data-xml="<detail><band height='79' status='noVisited' splitType='Stretch'/></detail>" class="split split-vertical" style="border: 1px solid #C0C0C0;height: 50px;" >
            </div>
            ...
            <div id="columnFooter" data-typeelement = 'columnFooter' data-nameTag="pageFooter" data-xml="<pageFooter><band height='79' status='noVisited' splitType='Stretch'/></pageFooter>" class="split split-vertical" style="border: 1px solid #C0C0C0;">
            </div>
            <div id="pageFooter" data-typeelement = 'pageFooter' data-nameTag="pageFooter" data-xml="<pageFooter><band height='79' status='noVisited' splitType='Stretch'/></pageFooter>" class="split split-vertical" >
            </div>
    ...
    <script type="text/javascript">
                            ...
                            action: function () {
                                ...
                                $.post( "/reportes.php/saveConnection",data, function( response ){
                                    ...
                                    if(!isNaN(Number(response)))
                                    {
                                        ...
                                        localStorage.setItem('data-driver', driverSend);
                                        $('#'+idOption).attr('data-host', hostSend);
                                        localStorage.setItem('data-host', hostSend);
                                        $('#'+idOption).attr('data-database', databaseSend);
                                        localStorage.setItem('data-database', databaseSend);
                                        $('#'+idOption).attr('data-user', userSend);
                                        localStorage.setItem('data-user', userSend);
                                        $('#'+idOption).attr('data-password', passwordSend);
                                        localStorage.setItem('data-password', passwordSend);
        ...
        function reportQuery()
        {
            $.confirm({
                ...
                content: 'url:/reportes.php/reportQuery',
                buttons: {
                    formSubmit: {
                        text: 'Submit',
                        btnClass: 'btn-blue',
                            ...
                            $.each(fields, function( index, value ) {
                                ...
                                xhr = $.post( "/reportes.php/getTypeColumn",data, function( response ) {
                                    if(response['datos'] != '')
                                    {
                                        ...
                                        var type;
                                        switch (response['datos'][0].DATA_TYPE)
                                        {
                                            case 'int':
        ...
        Split(['#title', '#pageHeader' ,'#columnHeader','#detail','#columnFooter','#pageFooter','#footer'], {
            direction: 'vertical',
            gutterSize: 9,
            cursor: 'col-resize'
        })
